 ...
 * v2 订阅模块
 */
export declare class V2NIMSubscribeService extends NIMEBaseServiceClass<V2NIMSubscribeListener> {
    /**
     ...
     */
    publishCustomUserStatus(params: V2NIMCustomUserStatusParams): Promise<void>;
    /**
     * 查询用户状态订阅关系。
     * 输入账号列表，查询自己订阅了哪些账号列表，返回订阅账号列表
     */
    queryUserStatusSubscribe(accountIds: Array<string>): Promise<Array<string>>;
}
...
export interface V2NIMUserStatus {
    ...
    /**
     * JSON格式。账号多端同时在线，状态多端同步
     */
    multiExtension?: string;
}
/**
 * 订阅用户状态请求参数
 */
 ...
 * 用户在线状态
 */
export declare enum V2NIMUserStatusType {
    /**
     * 未知
     */
